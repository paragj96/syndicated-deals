...
function printHelp ()
{
    ...
    echo -e "${GREEN}-n ${RESET}defaults to ${GREEN}syndicated-loan${RESET}. use ${YELLOW}-n your-named-network ${RESET}if you are using a different network name"  | indent
...
{
    echo ""
    echo -e "${YELLOW}network archive, start and deploy script for the Syndicated Loan" | indent
...
# V0.14
# composer-rest-server -p hlfv1 -n syndicated-loan -i admin -s adminPW
# V0.15
